...
def main():
    ...
    for file in files:
        ...
        np.savetxt(f'window/predictions_{apnea_type}_window_{file}.txt', predictions, delimiter=" ", fmt='%10f')
...
def load_test_dataset(file):
    ...
    testX = load_file_test(testX, file)
